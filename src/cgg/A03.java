...
/**
 * Aufgabe 3: Beleuchtung mit mehreren Lichtquellen und Schatten.
 */
public class A03 {
    public static void main(String[] args) {
        ...
        scene.add(new Sphere(new Vec3( 0,  0, -5), 1.0, new Color(0.2, 1.0, 1.0))); 
        scene.add(new Sphere(new Vec3( 2,  0, -6), 1.2, new Color(1.0, 0.5, 0.0))); 
        scene.add(new Sphere(new Vec3(0, -1001, -5), 1000, new Color(0.8, 0.8, 0.8)));
    ...
    static Color shade(Hit hit, List<Sphere> scene, List<Light> lights, Ray ray) {
        // Phong-Koeffizienten
        Color ka = multiply(0.1, hit.color());
        Color kd = multiply(0.6, hit.color());
        Color ks = multiply(0.3, new Color(1,1,1));
        double ke = 100;

        Color result = new Color(0,0,0);
        // Ambient-Anteil (global)
        result = add(result, ka);
